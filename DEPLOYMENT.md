...
3. **Repository Path**: `/home/polishst/pos.polishstation.lk`, the **same directory** as the Node app's root/document root (no separate "additional path"; this repo's `.cpanel.yml` assumes the repo _is_ the live app directory).
4. Branch: `main`.
