...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Integrated POS, bookings, and ERP platform for car detailing centers." },
      { property: "og:title", content: "Polish Station OS" },
      { property: "og:description", content: "POS, bookings, jobs, inventory and reports for detailing operations." },
