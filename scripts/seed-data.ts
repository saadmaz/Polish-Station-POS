...
const EQUIPMENT = [
  {
    ...
    lastServiceDate: daysAgo(45).slice(0, 10),
  ...
  },
  {
    ...
    lastServiceDate: daysAgo(195).slice(0, 10),
  ...
  },
  {
    ...
    status: "Active",
    serviceIntervalDays: 180,
    lastServiceDate: daysAgo(90).slice(0, 10),
...
async function main() {
  ...
  console.log("  wrote counters (bookings:205, invoices:2090, purchaseOrders:1001)");
