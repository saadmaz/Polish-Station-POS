...
const STAFF = [
  ...
  { id: "s2", name: "Ismail",   role: "Manager",    color: "oklch(0.60 0.13 240)", pinVar: "STAFF_PIN_s2" },
  { id: "s3", name: "Salman",   role: "Advisor",    color: "oklch(0.65 0.16 145)", pinVar: "STAFF_PIN_s3" },
  { id: "s4", name: "Mijwadh",  role: "Cashier",    color: "oklch(0.78 0.15 75)",  pinVar: "STAFF_PIN_s4" },
  { id: "s5", name: "Ayesha",   role: "Cashier",    color: "oklch(0.65 0.14 320)", pinVar: "STAFF_PIN_s5" },
  { id: "s6", name: "Saad",     role: "Technician", color: "oklch(0.45 0.20 20)",  pinVar: "STAFF_PIN_s6" },
  { id: "s7", name: "Ibrahim",  role: "Technician", color: "oklch(0.60 0.15 280)", pinVar: "STAFF_PIN_s7" },
  { id: "s8", name: "Abdullah", role: "Technician", color: "oklch(0.55 0.15 190)", pinVar: "STAFF_PIN_s8" },
  { id: "s9", name: "Abbas",    role: "Technician", color: "oklch(0.50 0.18 30)",  pinVar: "STAFF_PIN_s9" },
];
